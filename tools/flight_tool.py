...
API_KEY = os.getenv("AVIATIONSTACCK_API_KEY")
...
def parse_route(query: str):
    ...
    # Handle natural routes without "from", such as "Mumbai to UK", before
    # the destination-only rule can discard the origin.
